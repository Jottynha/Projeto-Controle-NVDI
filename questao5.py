...
def questao5_controle_PID(Ks=1.0, Kp=1.0):
    ...
    axes[0].semilogx(w, 20*np.log10(mag_p), 'b-', linewidth=2, label='P')
    axes[0].semilogx(w, 20*np.log10(mag_pi), 'g-', linewidth=2, label='PI')
    axes[0].semilogx(w, 20*np.log10(mag_pd), 'orange', linewidth=2, label='PD')
    axes[0].semilogx(w, 20*np.log10(mag_pid), 'r-', linewidth=2.5, label='PID')
    axes[0].axhline(0, color='k', linestyle='--', linewidth=1, alpha=0.5)
    axes[0].set_ylabel('Magnitude (dB)', fontsize=12)
    axes[0].set_title('Diagrama de Bode - Magnitude', fontsize=13, fontweight='bold')
    ...
    axes[1].semilogx(w, phase_p * 180/np.pi, 'b-', linewidth=2, label='P')
    axes[1].semilogx(w, phase_pi * 180/np.pi, 'g-', linewidth=2, label='PI')
    axes[1].semilogx(w, phase_pd * 180/np.pi, 'orange', linewidth=2, label='PD')
    axes[1].semilogx(w, phase_pid * 180/np.pi, 'r-', linewidth=2.5, label='PID')
    axes[1].axhline(-180, color='k', linestyle='--', linewidth=1, alpha=0.5)
    axes[1].set_ylabel('Fase (graus)', fontsize=12)
    axes[1].set_xlabel('Frequência (rad/dia)', fontsize=12)
    axes[1].set_title('Diagrama de Bode - Fase', fontsize=13, fontweight='bold')
